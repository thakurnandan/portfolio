...
export class Terminal extends Component {
    constructor() {
        ...
        var ageDifMs = Date.now()- new Date("01-01-2019");
        var ageDate = new Date(ageDifMs);
        this.child_directories = {
            root: ["books", "personal-documents", "skills", "languages", "mphasis", "interests", "experience"],
            mphasis: ["OnboardingForm-Jan2019.pdf"],
            experience: [ageDate.getUTCFullYear() - 1970],
            books: ["Clean-Architecture:A-Craftsman's-Guide-to-Software-Structure-and-Design.pdf", "Don't-Make-Me-Think:-A Common-Sense-Approach-to-Web-Usability"],
            skills: ["ConversationalAI", "MicrosoftBotFramework", "SpringBoot", "WindowsForm", "MicrosoftLuis"],
            interests: ["AI", "ML", "DataScience"],
            languages: ["Java", "C#", "Nodejs", "SpringBoot"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">nandan@hp</div>
